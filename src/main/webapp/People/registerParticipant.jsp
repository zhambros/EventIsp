<%@ page contentType="text/html;charset=UTF-8" language="java" %>
  <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <head>
      <title>Register Participation | My Masjid</title>
    ...
    <body>
      <% if (request.getSession().getAttribute("p_email") !=null) { %>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <h3 class="text-center">REGISTER PARTICIPATION</h3>
            </div>
          </div>
        </div>
        </br>
                    ...
                    <tbody>
                      <c:forEach var="event" items="${eventList}">
                        <tr>
                          ...
                          <td>
                            <form method="POST" action="../e/RegisterParticipant" style="margin: 0;">
